    ...
    private PrettyPrinter printProblem(PrettyPrinter printer, IMixinContext context, MethodNode mda, MethodNode mdb) {
        ...
        switch (this.problem) {
            ...
            case BAD_LOAD: {
                ...
                while (ia.hasNext() && ib.hasNext()) {
                    ...
                    if (na instanceof VarInsnNode && nb instanceof VarInsnNode) {
                        ...
                        printer.kv("Target " + index, "%8s %-2d %s", Bytecode.getOpcodeName((AbstractInsnNode)va), va.var, ta);
                        printer.kv("Incoming " + index, "%8s %-2d %s", Bytecode.getOpcodeName((AbstractInsnNode)vb), vb.var, tb);
            ...
            case BAD_CAST: {
                ...
                Type ta = Type.getObjectType((String)((TypeInsnNode)this.a).desc);
                Type tb = Type.getObjectType((String)((TypeInsnNode)this.b).desc);
