...
implements Closeable {
    ...
    public void sendRichPresence(RichPresence presence, Callback callback) {
        ...
        this.pipe.send(Packet.OpCode.FRAME, new JSONObject().put("cmd", (Object)"SET_ACTIVITY").put("args", (Object)new JSONObject().put("pid", IPCClient.getPID()).put("activity", (Object)(presence == null ? null : presence.toJson()))), callback);
    }
