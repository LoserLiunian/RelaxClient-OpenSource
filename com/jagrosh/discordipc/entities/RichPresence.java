...
public class RichPresence {
    ...
    public JSONObject toJson() {
        return new JSONObject().put("state", (Object)this.state).put("details", (Object)this.details).put("timestamps", (Object)new JSONObject().put("start", this.startTimestamp == null ? null : Long.valueOf(this.startTimestamp.toEpochSecond())).put("end", this.endTimestamp == null ? null : Long.valueOf(this.endTimestamp.toEpochSecond()))).put("assets", (Object)new JSONObject().put("large_image", (Object)this.largeImageKey).put("large_text", (Object)this.largeImageText).put("small_image", (Object)this.smallImageKey).put("small_text", (Object)this.smallImageText)).put("party", this.partyId == null ? null : new JSONObject().put("id", (Object)this.partyId).put("size", (Object)new JSONArray().put(this.partySize).put(this.partyMax))).put("secrets", (Object)new JSONObject().put("join", (Object)this.joinSecret).put("spectate", (Object)this.spectateSecret).put("match", (Object)this.matchSecret)).put("instance", this.instance);
    }
