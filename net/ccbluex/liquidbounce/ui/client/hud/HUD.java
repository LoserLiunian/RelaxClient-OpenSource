...
import net.ccbluex.liquidbounce.ui.client.hud.element.elements.HurtTimeHud;
...
import net.ccbluex.liquidbounce.ui.client.hud.element.elements.KeyStrokes;
import net.ccbluex.liquidbounce.ui.client.hud.element.elements.MemoryHud;
...
extends MinecraftInstance {
    ...
    static {
        ...
        elements = new Class[]{Inventory.class, Armor.class, Text2.class, KeyStrokes.class, PlayerList.class, Arraylist.class, Effects.class, Image.class, MemoryHud.class, HealthHud.class, ArmorHud.class, TargetHud.class, Model.class, HurtTimeHud.class, GameInfo.class, NewEffects.class, Notifications.class, KeyBinds.class, TabGUI.class, Text.class, ScoreboardElement.class, Target.class, Radar.class, SpeedGraph.class};
    }
    ...
    @Metadata(mv={1, 1, 16}, bv={1, 0, 3}, k=1, d1={"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002J\b\u0010\n\u001a\u00020\u000bH\u0007R!\u0010\u0003\u001a\u0010\u0012\f\u0012\n\u0012\u0006\b\u0001\u0012\u00020\u00060\u00050\u0004\u00a2\u0006\n\n\u0002\u0010\t\u001a\u0004\b\u0007\u0010\b\u00a8\u0006\f"}, d2={"Lnet/ccbluex/liquidbounce/ui/client/hud/HUD$Companion;", "", "()V", "elements", "", "Ljava/lang/Class;", "Lnet/ccbluex/liquidbounce/ui/client/hud/element/Element;", "getElements", "()[Ljava/lang/Class;", "[Ljava/lang/Class;", "createDefault", "Lnet/ccbluex/liquidbounce/ui/client/hud/HUD;", "Relaxed"})
    public static final class Companion {
        ...
        public final HUD createDefault() {
            return new HUD().addElement(Text.Companion.defaultClient()).addElement(new Arraylist(0.0, 0.0, 0.0f, null, 15, null)).addElement(new ScoreboardElement(0.0, 0.0, 0.0f, null, 15, null)).addElement(new Armor(0.0, 0.0, 0.0f, null, 15, null)).addElement(new Effects(0.0, 0.0, 0.0f, null, 15, null)).addElement(new Notifications(0.0, 0.0, 0.0f, null, 15, null));
        }
