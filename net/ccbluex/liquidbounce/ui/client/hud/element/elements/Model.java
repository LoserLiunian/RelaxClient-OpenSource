    ...
    public Border drawElement() {
        block27: {
            ...
            switch (tmp) {
                ...
                case 1: {
                    v3 = ((Number)this.customYaw.get()).floatValue();
                    break;
                }
                default: {
                    v3 = 0.0f;
            ...
            switch (var3_4.hashCode()) {
                ...
                case -985752863: {
                    ...
                    v7 = v6.getRotationPitch();
                    break block27;
                }
            }
            v7 = ((Number)this.customPitch.get()).floatValue();
            break block27;
            v7 = pitch = 0.0f;
        }
        ...
        this.drawEntityOnScreen(yaw, pitch, v9);
