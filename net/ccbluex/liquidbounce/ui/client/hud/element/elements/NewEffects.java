...
extends Element {
    ...
    public Border drawElement() {
        ...
        for (IPotionEffect potionEffect : mc.getThePlayer().getActivePotionEffects()) {
            ...
            if (((Boolean)blur.get()).booleanValue()) {
                GL11.glTranslated((double)(-this.getRenderX()), (double)(-this.getRenderY()), (double)0.0);
                BlurBuffer.blurArea((float)this.getRenderX(), (float)this.getRenderY() + (float)Math.round(potionData.translate.getY()), 120.0f, 30.0f);
                GL11.glTranslated((double)this.getRenderX(), (double)this.getRenderY(), (double)0.0);
            }
            ...
            Fonts.font35.drawString(potionEffect.getDurationString(), 29.0f, posY + 4.0f, ClientUtils.reAlpha(new Color(200, 200, 200).getRGB(), 0.5f));
