...
extends WrappedGuiScreen {
    ...
    private final IResourceLocation hudIcon = classProvider.createResourceLocation("Relaxed".toLowerCase() + "/custom_hud_icon.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        switch ((String)((ClickGUI)Objects.requireNonNull(LiquidBounce.moduleManager.getModule(ClickGUI.class))).backgroundValue.get()) {
            case "Default": {
                ...
                RenderUtils.drawRect(0, sr.func_78328_b(), sr.func_78326_a(), sr.func_78328_b() - this.scroll, -804253680);
            }
        }
