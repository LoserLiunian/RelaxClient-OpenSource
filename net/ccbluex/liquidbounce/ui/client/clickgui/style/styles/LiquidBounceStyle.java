...
extends Style {
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.fontSFUI35.getFontHeight() + 3, 1.0f, new Color(255, 255, 255, 89).getRGB(), Integer.MIN_VALUE);
