...
public final class IconUtils {
    public static ByteBuffer[] getFavicon() {
        try {
            return new ByteBuffer[]{IconUtils.readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/" + "Relaxed".toLowerCase() + "/icon_16x16.png")), IconUtils.readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/" + "Relaxed".toLowerCase() + "/icon_32x32.png"))};
        }
        catch (IOException e) {
            e.printStackTrace();
            return null;
