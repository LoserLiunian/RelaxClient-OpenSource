...
extends MinecraftInstance {
    ...
    public Shader(String fragmentShader) {
        ...
        int vertexShaderID;
        try {
            InputStream vertexStream = this.getClass().getResourceAsStream("/assets/minecraft/relaxed/shader/vertex.vert");
            ...
            InputStream fragmentStream = this.getClass().getResourceAsStream("/assets/minecraft/relaxed/shader/fragment/" + fragmentShader);
