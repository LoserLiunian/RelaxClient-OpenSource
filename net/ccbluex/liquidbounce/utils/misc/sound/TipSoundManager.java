...
@Metadata(mv={1, 1, 16}, bv={1, 0, 3}, k=1, d1={"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u00020\u0001B\u0005\u00a2\u0006\u0002\u0010\u0002R\u001a\u0010\u0003\u001a\u00020\u0004X\u0086\u000e\u00a2\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\bR\u001a\u0010\t\u001a\u00020\u0004X\u0086\u000e\u00a2\u0006\u000e\n\u0000\u001a\u0004\b\n\u0010\u0006\"\u0004\b\u000b\u0010\b\u00a8\u0006\f"}, d2={"Lnet/ccbluex/liquidbounce/utils/misc/sound/TipSoundManager;", "", "()V", "disableSound", "Lnet/ccbluex/liquidbounce/utils/misc/sound/TipSoundPlayer;", "getDisableSound", "()Lnet/ccbluex/liquidbounce/utils/misc/sound/TipSoundPlayer;", "setDisableSound", "(Lnet/ccbluex/liquidbounce/utils/misc/sound/TipSoundPlayer;)V", "enableSound", "getEnableSound", "setEnableSound", "Relaxed"})
public final class TipSoundManager {
    ...
    public final void setEnableSound(@NotNull TipSoundPlayer tipSoundPlayer) {
        Intrinsics.checkParameterIsNotNull(tipSoundPlayer, "<set-?>");
    ...
    public TipSoundManager() {
        ...
        if (!enableSoundFile.exists()) {
            FileUtils.unpackFile(enableSoundFile, "assets/minecraft/relaxed/sound/enable.wav");
        }
        if (!disableSoundFile.exists()) {
            FileUtils.unpackFile(disableSoundFile, "assets/minecraft/relaxed/sound/disable.wav");
        }
