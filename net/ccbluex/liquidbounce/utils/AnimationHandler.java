    ...
    public void preRender(RenderChunk renderChunk) {
        if (this.timeStamps.containsKey(renderChunk)) {
            ...
            if ((timeDif = System.currentTimeMillis() - time) < (long)(animationDuration = ((Integer)WolrdAnim.chunkAnimationDurationValue.get()).intValue())) {
                double chunkY = renderChunk.func_178568_j().func_177956_o();
                int chunkPos = (Integer)WolrdAnim.chunkPositionValue.get();
                switch ((String)WolrdAnim.animmode.get()) {
                    case "UP": {
                        GlStateManager.func_179137_b((double)0.0, (double)((double)(-chunkPos) - chunkY - ((double)(-chunkPos) - chunkY) / (double)animationDuration * (double)timeDif), (double)0.0);
                        break;
                    }
                    case "Down": {
                        GlStateManager.func_179137_b((double)0.0, (double)((double)chunkPos - chunkY - ((double)chunkPos - chunkY) / (double)animationDuration * (double)timeDif), (double)0.0);
                    ...
                    default: {
                        ...
                        GlStateManager.func_179137_b((double)((double)vec.getX() * animationPosition), (double)0.0, (double)((double)vec.getZ() * animationPosition));
                        break;
                    }
                }
            } else {
