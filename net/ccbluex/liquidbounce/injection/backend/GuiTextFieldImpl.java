...
implements IGuiTextField {
    ...
    public String getText() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.text");
        return string;
    }
