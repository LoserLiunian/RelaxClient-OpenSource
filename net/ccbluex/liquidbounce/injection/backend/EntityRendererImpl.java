...
implements IEntityRenderer {
    ...
    public void loadShader2(@NotNull ResourceLocation resourceLocation) {
        ...
        boolean bl3 = false;
        EntityRendererImpl $this$unwrap$iv = this;
        boolean $i$f$unwrap = false;
        EntityRendererImpl entityRendererImpl = $this$unwrap$iv;
        if (entityRendererImpl == null) {
        ...
        entityRendererImpl.getWrapped();
        ResourceLocation resourceLocation3 = resourceLocation2;
        entityRenderer.func_175069_a(resourceLocation3);
    }
