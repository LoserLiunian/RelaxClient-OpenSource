...
implements ISession {
    ...
    public String getUsername() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.username");
        return string;
    }
    ...
    public String getPlayerId() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.playerID");
        return string;
    }
    ...
    public String getToken() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.token");
        return string;
    }
