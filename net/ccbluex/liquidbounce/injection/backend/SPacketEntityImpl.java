...
implements ISPacketEntity {
    ...
    public IEntity getEntity(@NotNull IWorld world) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(entity, "wrapped.getEntity(world.unwrap())");
