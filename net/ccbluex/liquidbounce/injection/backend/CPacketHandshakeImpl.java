...
implements ICPacketHandshake {
    ...
    public String getIp() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.ip");
        return string;
    }
