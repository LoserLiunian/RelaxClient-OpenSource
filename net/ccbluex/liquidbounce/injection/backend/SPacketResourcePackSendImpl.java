...
implements ISPacketResourcePackSend {
    ...
    public String getUrl() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.url");
        return string;
    }
    ...
    public String getHash() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.hash");
        return string;
    }
