...
implements IMinecraft {
    ...
    public INetHandlerPlayClient getNetHandler2() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(netHandlerPlayClient3, "wrapped.connection!!.also { unwrap() }");
        return (INetHandlerPlayClient)netHandlerPlayClient3;
    }
