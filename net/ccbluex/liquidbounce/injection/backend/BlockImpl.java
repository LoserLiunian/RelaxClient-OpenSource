...
implements IBlock {
    ...
    public String getLocalizedName() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.localizedName");
        return string;
    }
    ...
    public IAxisAlignedBB getSelectedBoundingBox(@NotNull IWorld world, @NotNull IIBlockState blockState, @NotNull WBlockPos blockPos) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(axisAlignedBB, "wrapped.getBoundingBox(b\u2026offset(blockPos.unwrap())");
