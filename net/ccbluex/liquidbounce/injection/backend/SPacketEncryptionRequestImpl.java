...
implements ISPacketEncryptionRequest {
    ...
    public byte[] getVerifyToken() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(byArray, "wrapped.verifyToken");
        return byArray;
    }
