...
implements IEntity {
    ...
    public float getDistanceToEntity2(@Nullable IEntityLivingBase it) {
        void $this$unwrap$iv;
        IEntityLivingBase iEntityLivingBase = it;
        ...
        EntityLivingBase entityLivingBase = (EntityLivingBase)((EntityLivingBaseImpl)v1).getWrapped();
        return t.func_70032_d((Entity)entityLivingBase);
    }
