...
implements IExtractedFunctions {
    ...
    @Override
    @NotNull
    public String formatI18n(@NotNull String key, String ... values2) {
        Intrinsics.checkParameterIsNotNull(key, "key");
        Intrinsics.checkParameterIsNotNull(values2, "values");
        String string = I18n.func_135052_a((String)key, (Object[])new Object[]{values2});
        Intrinsics.checkExpressionValueIsNotNull(string, "I18n.format(key, values)");
        return string;
    }
    ...
    public String scoreboardFormatPlayerName(@Nullable ITeam scorePlayerTeam, @NotNull String playerName) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "ScorePlayerTeam.formatPl\u2026am?.unwrap(), playerName)");
        return string;
    }
    ...
    @Override
    @NotNull
    public IIChatComponent jsonToComponent(@NotNull String toString2) {
        Intrinsics.checkParameterIsNotNull(toString2, "toString");
        ITextComponent iTextComponent = ITextComponent.Serializer.func_150699_a((String)toString2);
