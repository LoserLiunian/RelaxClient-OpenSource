...
implements IServerData {
    ...
    public String getGameVersion() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.gameVersion");
        return string;
    }
    ...
    public String getServerMOTD() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.serverMOTD");
        return string;
    }
    ...
    public String getPopulationInfo() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.populationInfo");
        return string;
    }
    ...
    public String getServerName() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.serverName");
        return string;
    }
    ...
    public String getServerIP() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.serverIP");
        return string;
    }
