...
implements ICPacketCustomPayload {
    ...
    public String getChannelName() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(string, "wrapped.channelName");
        return string;
    }
