...
public final class ClassProviderImpl$WhenMappings {
    ...
    static {
        ...
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.JUMP.ordinal()] = 2;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.HEAL.ordinal()] = 3;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.REGENERATION.ordinal()] = 4;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.BLINDNESS.ordinal()] = 5;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.MOVE_SPEED.ordinal()] = 6;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.HUNGER.ordinal()] = 7;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.DIG_SLOWDOWN.ordinal()] = 8;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.CONFUSION.ordinal()] = 9;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.WEAKNESS.ordinal()] = 10;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.MOVE_SLOWDOWN.ordinal()] = 11;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.HARM.ordinal()] = 12;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.WITHER.ordinal()] = 13;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.POISON.ordinal()] = 14;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.NIGHT_VISION.ordinal()] = 15;
