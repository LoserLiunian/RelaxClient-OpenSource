...
implements ICPacketPlayerDigging {
    ...
    public WBlockPos getPosition() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(blockPos3, "wrapped.position");
