...
implements IWorld {
    ...
    public IIBlockState getBlockState(@NotNull WBlockPos blockPos) {
        ...
        IBlockState iBlockState = t.func_180495_p(blockPos2);
