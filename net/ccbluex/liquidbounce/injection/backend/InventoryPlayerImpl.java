...
implements IInventoryPlayer {
    ...
    public IWrappedArray<IItemStack> getMainInventory() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(nonNullList, "wrapped.mainInventory");
    ...
    public IWrappedArray<IItemStack> getArmorInventory() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(nonNullList, "wrapped.armorInventory");
