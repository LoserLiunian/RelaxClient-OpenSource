...
lbl292:
    ...
    private final boolean checkVoid() {
        ...
        for (int i = (int)(-((v432171).getPosY() - 1.4857625)); i <= 0; ++i) {
                    ...
                    if (!module2.getState()) {
                        ...
                        if (packet instanceof CPacketPlayer) {
                            if (this.isInVoid()) {
                                ...
                                if (!this.packets.isEmpty()) {
                                    Iterator<CPacketPlayer> iterator2 = this.packets.iterator();
                                    Intrinsics.checkExpressionValueIsNotNull(iterator2, "packets.iterator()");
                                    Iterator<CPacketPlayer> var3 = iterator2;
