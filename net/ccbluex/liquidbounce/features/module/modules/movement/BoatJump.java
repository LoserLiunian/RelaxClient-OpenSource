                ...
                switch (string.hashCode()) {
                    case -1081239615: {
                        if (string.equals("matrix")) {
                            ...
                            netHandlerPlayClient.func_147297_a((Packet)new CPacketInput(f, iEntityPlayerSP6.getMoveForward(), false, true));
                            break;
                        }
                    }
                    default: {
                        ...
                        netHandlerPlayClient.func_147297_a((Packet)new CPacketInput(f, iEntityPlayerSP8.getMoveForward(), false, true));
                        break;
                    }
                }
            }
