...
extends SpeedMode {
    ...
    public void onMotion() {
        if (MovementUtils.isMoving()) {
            ...
            if (CustomSpeed.mc2.field_71439_g.field_70122_E) {
                MovementUtils.strafe(((Float)speed.customSpeedValue.get()).floatValue());
                CustomSpeed.mc2.field_71439_g.field_70181_x = ((Float)speed.customYValue.get()).floatValue();
            ...
            CustomSpeed.mc2.field_71439_g.field_70179_y = 0.0;
            CustomSpeed.mc2.field_71439_g.field_70159_w = 0.0;
        }
    }
    ...
    public void onEnable() {
        ...
        if (((Boolean)speed.resetYValue.get()).booleanValue()) {
            CustomSpeed.mc2.field_71439_g.field_70181_x = 0.0;
        }
        super.onEnable();
    }
