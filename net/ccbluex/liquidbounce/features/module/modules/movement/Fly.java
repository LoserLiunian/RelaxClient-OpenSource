...
extends Module {
    ...
    private final void handleVanillaKickBypass() {
        ...
        for (double posY = (v436767).getPosY(); posY > ground; posY -= 8.0) {
    ...
    private final double calculateGround() {
        ...
        for (double ground = (v437098).getPosY(); ground > 0.0; ground -= blockHeight) {
