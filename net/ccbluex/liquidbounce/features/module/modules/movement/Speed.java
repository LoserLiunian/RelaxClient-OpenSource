...
extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        SpeedMode speedMode;
        if (Speed.mc2.field_71439_g.func_70093_af()) {
            return;
        }
        if (MovementUtils.isMoving()) {
            Speed.mc2.field_71439_g.func_70031_b(true);
        }
    ...
    public void onMotion(MotionEvent event) {
        SpeedMode speedMode;
        if (Speed.mc2.field_71439_g.func_70093_af() || event.getEventState() != EventState.PRE) {
            return;
        }
        if (MovementUtils.isMoving()) {
            Speed.mc2.field_71439_g.func_70031_b(true);
    ...
    public void onEnable() {
        if (Speed.mc2.field_71439_g == null) {
            return;
        }
