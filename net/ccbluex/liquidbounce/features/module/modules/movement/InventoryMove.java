...
extends Module {
    ...
    private final void updateKeyState() {
        if (!(MinecraftInstance.mc2.field_71462_r == null || MinecraftInstance.mc2.field_71462_r instanceof GuiChat || ((Boolean)this.noDetectableValue.get()).booleanValue() && MinecraftInstance.mc2.field_71462_r instanceof GuiContainer)) {
