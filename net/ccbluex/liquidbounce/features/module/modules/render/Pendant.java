...
extends Module {
    ...
    public void Fubuki() {
        if (((String)this.Fubukistyle.get()).contains("GIF")) {
            ...
            RenderUtils.drawImage(classProvider.createResourceLocation("relaxed/fubuki/" + state + ".png"), ((Float)this.positionX.getValue()).intValue(), VisualUtils.height() - ((Float)this.positionY.getValue()).intValue(), ((Float)this.size.getValue()).intValue(), ((Float)this.size.getValue()).intValue());
        }
        if (((String)this.Fubukistyle.get()).contains("Static")) {
            RenderUtils.drawImage(classProvider.createResourceLocation("relaxed/fubuki/Static.png"), ((Float)this.positionX.getValue()).intValue(), VisualUtils.height() - ((Float)this.positionY.getValue()).intValue(), 77, 250);
        }
    }
    ...
    public void Taco() {
        ...
        RenderUtils.drawImage(classProvider.createResourceLocation("relaxed/taco/" + state + ".png"), (int)this.posX, VisualUtils.height() - 80, 42, 27);
    }
}
