...
extends Module {
        ...
        if (this.domainResourceManagers == null) {
            try {
                ...
                for (Field field : fields = SimpleReloadableResourceManager.class.getDeclaredFields()) {
                    ...
                    this.domainResourceManagers = (Map)field.get(mc2.func_110442_L());
                    break;
                }
            }
    ...
    public boolean isFastRenderEnabled() {
        try {
            ...
            return fastRender.getBoolean(MotionBlur.mc2.field_71474_y);
        }
        catch (Exception exception) {
            return false;
        }
    ...
    public void onTick(TickEvent event) {
        if (!(MotionBlur.mc2.field_71460_t.func_147702_a() && this.lastValue == (Integer)MOTION_BLUR_AMOUNT.get() || MotionBlur.mc2.field_71441_e == null || this.isFastRenderEnabled())) {
            this.lastValue = (Integer)MOTION_BLUR_AMOUNT.get();
            this.applyShader();
        }
        if (this.domainResourceManagers == null) {
