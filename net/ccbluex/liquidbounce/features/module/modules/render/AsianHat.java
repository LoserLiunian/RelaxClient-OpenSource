...
extends Module {
    ...
    public void onRender3D(Render3DEvent event) {
        EntityPlayerSP entity = AsianHat.mc2.field_71439_g;
        if (entity == null || ((Boolean)this.noFirstPerson.get()).booleanValue() && AsianHat.mc2.field_71474_y.field_74320_O == 0) {
            return;
        }
        ...
        double posX = entity.field_70142_S + (entity.field_70165_t - entity.field_70142_S) * (double)AsianHat.mc2.field_71428_T.field_194147_b;
        double posY = entity.field_70137_T + (entity.field_70163_u - entity.field_70137_T) * (double)AsianHat.mc2.field_71428_T.field_194147_b;
        double posZ = entity.field_70136_U + (entity.field_70161_v - entity.field_70136_U) * (double)AsianHat.mc2.field_71428_T.field_194147_b;
