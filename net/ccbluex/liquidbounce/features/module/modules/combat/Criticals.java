...
extends Module {
    ...
    static /* synthetic */ void sendCriticalPacket$default(Criticals criticals, double d, double d2, double d3, boolean bl, int n, Object object) {
        if ((n & 1) != 0) {
            d = 0.0;
        }
        if ((n & 2) != 0) {
