...
extends Module {
    ...
    public void onStrafe(StrafeEvent event) {
        if (this.lookupRotation != null && ((Boolean)this.rotationStrafeValue.get()).booleanValue()) {
            float f;
            int dif = (int)((MathHelper.func_76142_g((float)(mc.getThePlayer().getRotationYaw() - this.lookupRotation.getYaw() - 23.5f - 135.0f)) + 180.0f) / 45.0f);
    ...
    public void onMotion(MotionEvent event) {
        if (((Boolean)this.rotationsValue.get()).booleanValue() && ((Boolean)this.keepRotationValue.get()).booleanValue() && this.lockRotation != null) {
            RotationUtils.setTargetRotation(RotationUtils.limitAngleChange(RotationUtils.serverRotation, this.lockRotation, RandomUtils.nextFloat((float)((Float)this.minTurnSpeed.get()).floatValue(), (float)((Float)this.maxTurnSpeed.get()).floatValue())));
        }
        String mode = (String)this.modeValue.get();
        ...
        if (eventState == EventState.PRE) {
            ...
            if (InventoryUtils.findAutoBlockBlock() != -1 || isHeldItemBlock) {
                ...
                if (mc.getTheWorld().getBlockState(WBlockPos2).getBlock() instanceof BlockAir && this.search(WBlockPos2, true, true) && ((Boolean)this.rotationsValue.get()).booleanValue() && (vecRotation = RotationUtils.faceBlock(WBlockPos2)) != null) {
                    RotationUtils.setTargetRotation(RotationUtils.limitAngleChange(RotationUtils.serverRotation, vecRotation.getRotation(), RandomUtils.nextFloat((float)((Float)this.minTurnSpeed.get()).floatValue(), (float)((Float)this.maxTurnSpeed.get()).floatValue())));
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        if (counterMode.equalsIgnoreCase("advanced")) {
            ...
            if (canRenderStack) {
                ...
                GlStateManager.func_179109_b((float)(scaledResolution.getScaledWidth() / 2 - 8), (float)(scaledResolution.getScaledHeight() / 2 - 25), (float)(scaledResolution.getScaledWidth() / 2 - 8));
        ...
        if (counterMode.equalsIgnoreCase("novoline")) {
            if (this.slot >= 0 && this.slot < 9 && mc.getThePlayer().getInventory().getMainInventory().get(this.slot) != null && mc.getThePlayer().getInventory().getMainInventory().get(this.slot).getItem() != null && mc.getThePlayer().getInventory().getMainInventory().get(this.slot).getItem() instanceof ItemBlock) {
                GlStateManager.func_179094_E();
                GlStateManager.func_179109_b((float)(scaledResolution.getScaledWidth() / 2 - 22), (float)(scaledResolution.getScaledHeight() / 2 + 16), (float)(scaledResolution.getScaledWidth() / 2 - 22));
                this.renderItemStack(mc.getThePlayer().getInventory().getMainInventory().get(this.slot), 0, 0);
                GlStateManager.func_179121_F();
            }
            GlStateManager.func_179117_G();
    ...
    private boolean search(WBlockPos blockPosition, boolean checks, boolean towerActive) {
        ...
        if (((Boolean)this.rotationsValue.get()).booleanValue()) {
            if (((Float)this.minTurnSpeed.get()).floatValue() < 180.0f) {
                Rotation limitedRotation = RotationUtils.limitAngleChange(RotationUtils.serverRotation, placeRotation.getRotation(), RandomUtils.nextFloat((float)((Float)this.minTurnSpeed.get()).floatValue(), (float)((Float)this.maxTurnSpeed.get()).floatValue()));
