...
extends Module {
    ...
    public final void onMotion(@NotNull MotionEvent event) {
        ...
        if (event.isPre()) {
            v0 = MinecraftInstance.mc2.field_71439_g;
            if (v0 == null) {
                Intrinsics.throwNpe();
            }
            if (!(v0.field_71071_by.func_70448_g() == null || !MinecraftInstance.mc.getGameSettings().getKeyBindUseItem().isKeyDown() || ((Boolean)this.stopMoving.get()).booleanValue() && PlayerUtil.isMoving())) {
                v1 = MinecraftInstance.mc2.field_71439_g;
                if (v1 == null) {
                    Intrinsics.throwNpe();
                }
                v2 = v1.field_71071_by.func_70448_g();
                Intrinsics.checkExpressionValueIsNotNull(v2, "mc2.player!!.inventory.getCurrentItem()");
                heldItem = v2.func_77973_b();
