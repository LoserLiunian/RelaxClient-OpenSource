    ...
    public void execute(@NotNull String[] args2) {
        block6: {
            block5: {
                ...
                if (!StringsKt.equals(args2[1], "load", true)) break block5;
                if (args2.length < 3) {
            ...
            if (!StringsKt.equals(args2[1], "list", true)) break block6;
            this.chat("Loading settings...");
