...
extends SimpleChannelInboundHandler<Object> {
    ...
    public void channelInactive(@NotNull ChannelHandlerContext ctx) {
        ...
        this.client.setChannel$Relaxed(null);
    ...
    protected void channelRead0(@NotNull ChannelHandlerContext ctx, @NotNull Object msg) {
        block7: {
            ...
            block6: {
                ...
                this.client.onMessage$Relaxed(string);
                break block7;
            }
    ...
    public ClientHandler(@NotNull Client client2, @NotNull WebSocketClientHandshaker handshaker) {
