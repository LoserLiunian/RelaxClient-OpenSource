...
public class FontUtils {
    ...
    private Font getFont(String fontName, int fontType, int size) {
        Font font = null;
        try {
            InputStream ex = Minecraft.func_71410_x().func_110442_L().func_110536_a(new ResourceLocation("flux/font/" + fontName)).func_110527_b();
    ...
    public void drawStringWithGudShadow(String text, float x, float y, int color) {
        this.drawString(StringUtils.func_76338_a((String)text), x + 1.0f, y + 1.0f, this.getShadowColor(color).getRGB());
    ...
    public int drawStringWithShadow(String text, float x, float y, int color) {
        this.drawStringWithAlpha(StringUtils.func_76338_a((String)text), x + 0.5f, y + 0.4f, 0, (float)(color >> 24 & 0xFF) / 255.0f);
        return this.drawString(text, x, y, color);
    }

    public void drawStringWithSuperShadow(String text, float x, float y, int color) {
        this.drawStringWithAlpha(StringUtils.func_76338_a((String)text), x + 0.8f, y + 0.8f, 0, (float)(color >> 24 & 0xFF) / 255.0f);
        this.drawString(text, x, y, color);
    }
    ...
    public void drawCenteredStringWithShadow(String text, float x, float y, int color) {
        this.drawCenteredString(StringUtils.func_76338_a((String)text), x + 0.5f, y + 0.5f, -16777216);
    ...
    public float getStringWidth(String s) {
        ...
        float width = 0.0f;
        String str = StringUtils.func_76338_a((String)s);
