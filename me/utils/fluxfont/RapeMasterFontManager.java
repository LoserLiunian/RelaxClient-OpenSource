...
public class RapeMasterFontManager {
    ...
    public static final Font getFont() {
        Font font;
        try {
            InputStream is = Minecraft.func_71410_x().func_110442_L().func_110536_a(new ResourceLocation("relaxed/font/wqy_microhei.ttf")).func_110527_b();
    ...
    protected final int drawChar(char chr, float x, float y) {
        ...
        GlStateManager.func_179144_i((int)this.getOrGenerateCharTexture(region));
