...
public interface Config {
    ...
    public static final boolean USE_SUNDAY_QUICK_SEARCH = false;
    public static final boolean USE_CEC = false;
    public static final boolean USE_BYTE_MAP = false;
    public static final boolean USE_INT_MAP_BACKWARD = true;
